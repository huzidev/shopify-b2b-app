...
export default function AppCreateCatalog() {
  ...
  const steps = [
    { id: 1, label: "Company & Location", completed: !!selectedCompanyId && selectedLocationIds.length > 0 },
  ...
  useEffect(() => {
    ...
    if (company) {
      if (company.locations && company.locations.length > 0) {
        ...
        setSelectedLocationIds([company.locationShopifyId]);
      } else {
        setLocations([]);
        setSelectedLocationIds([]);
      }
  ...
  const handleSubmit = () => {
    ...
    fetcher.submit(
      { 
        ...
        locationIds: JSON.stringify(selectedLocationIds),
  ...
  const canProceedToNext = () => {
    switch (currentStep) {
      case 1:
        return selectedCompanyId && selectedLocationIds.length > 0;
      case 2:
        ...
        return (
          <Card sectioned>
            <BlockStack gap="400">
              ...
              {locations.length > 0 && (
                <ChoiceList
                  title="Select Company Locations"
                  titleHidden={false}
                  allowMultiple
                  ...
                  <InlineStack wrap={false} gap="400">
                    <Box style={{ flex: 1 }}>
                      ...
                      <Text variant="bodyMd">
                        ...
                        {locations
                          .filter(l => selectedLocationIds.includes(l.shopifyId))
                          .map(l => l.name)
                          .join(", ")}
                      </Text>
                    </Box>
